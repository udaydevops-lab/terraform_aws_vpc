...
creat all subnets public and private in different availability zones 
create route tables
create routes
associate with subnets
create eip elastic Ip 
create Nat gateway 
add natgateway to private subnets and db subnets 
...
(we can override the commontags with resource tags) 

vpc tags, subnet tags, nat gateway tags, name = something
